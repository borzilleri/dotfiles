" Setup path to vimrc as global variable
...
" Add dictionary word completion
...
map <silent> <leader>e :execute 'edit' g:vimrc<cr>
...
autocmd! BufWritePost g:vimrc source g:vimrc
